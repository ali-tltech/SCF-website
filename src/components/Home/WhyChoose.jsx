...
const WhyChoose = () => {
  return (
    <section className="bg-blue-100 md:p-20 p-5 rounded-lg flex flex-col md:h-screen md:flex-row sm:flex-col items-center md:items-start space-y-8 md:space-y-0 md:space-x-8">
