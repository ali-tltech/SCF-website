    ...
    <div className="mt-8 text-black py-8 px-4 md:px-8 relative overflow-hidden ">
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full md:w-1/2 space-y-6">
            ...
            <p className="text-gray-600  leading-relaxed text-lg">
              ...
              Today, SCF Strategies is recognized as an industry leader in SCF consulting.
            </p>
        ...
        <p className="text-gray-600 mt-4   leading-relaxed text-lg">
            Corporates, financial institutions and Fintechs rely on our advisory and enablement services, built on actual in-depth program-level expertise. With over 100 SCF programs implemented globally, we&apos;ve learned from the challenges and mistakes to ensure you don&apos;t have to.
